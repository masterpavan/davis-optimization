...
// Show and Play the youtube video when clicked
  Drupal.behaviors.ucdeduHeroBannerShowVideo = {
    attach: function (context) {
      $('.hero-banner__play', context).on('click', function (e) {
        e.preventDefault();
        e.stopPropagation();
        ...
        $('.hero-banner__body, .hero-banner__media').addClass('is-hidden');
      });
    }
  };
